    ...
    <View style={styles.container}>
      ...
      <View style={styles.bottomNav}>
        <Pressable style={styles.navItem} onPress={() => { }}>
          ...
          <Text style={[styles.navItemText, { color: colors.primary }]}>HOME</Text>
        </Pressable>
        <Pressable style={styles.navItem} onPress={() => router.push('/history')}>
          <MaterialCommunityIcons name="history" size={24} color="rgba(255,255,255,0.4)" />
          <Text style={styles.navItemText}>HISTORY</Text>
        </Pressable>
        <Pressable style={styles.navItem} onPress={() => { }}>
          <MaterialCommunityIcons name="chart-bar" size={24} color="rgba(255,255,255,0.4)" />
          <Text style={styles.navItemText}>STATS</Text>
        </Pressable>
        <Pressable style={styles.navItem} onPress={() => { }}>
          <MaterialCommunityIcons name="account-outline" size={24} color="rgba(255,255,255,0.4)" />
